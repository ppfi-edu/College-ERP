...
export default function FeeManagementSystem() {
  ...
  const fetchAllFees = async () => {
    try {
      ...
      const response = await fetch('https://server.ppfi.site/api/fee/Fee')
  ...
  const handleSearch = async () => {
    try {
      const response = await fetch(`https://server.ppfi.site/api/fee/${searchTerm}`)
  ...
  const handleCreateFee = async (e) => {
    ...
    try {
      ...
      const url = 'https://server.ppfi.site/api/fee/create-fee'
      const method = 'POST'
  ...
  const handleUpdateFee = async (id) => {
    try {
        const url = `https://server.ppfi.site/api/fee/update`
        const method = 'PUT'
        const response = await fetch(url, {
            method,
            headers: { 'Content-Type': 'application/json' },
  ...
  const handleAddFeeForAll = async (reason, amount) => {
    try {
        const response = await fetch('https://server.ppfi.site/api/fee/AddFee', {
            method: 'POST',
            headers: {
...
const handleDeleteFee = async (id) => {
    try {
        const response = await fetch(`https://server.ppfi.site/api/fee/delete/${id}`, {
            method: 'DELETE'
        });
