...
export default function LibraryBooks() {
  ...
  const fetchAllBooks = async () => {
    try {
      const response = await fetch('https://server.ppfi.site/api/lib')
  ...
  const handleAddBook = async (e) => {
    e.preventDefault()
    try {
      const response = await fetch('https://server.ppfi.site/api/lib/add', {
        method: 'POST',
  ...
  const handleIssueBook = async (e) => {
    e.preventDefault()
    try {
      const response = await fetch(`https://server.ppfi.site/api/lib/IssueBook/${issueBook.id}`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleReturnBook = async (e) => {
    e.preventDefault()
    try {
      const response = await fetch(`https://server.ppfi.site/api/lib/return/${returnBook.id}`, {
        method: 'POST'
      })
  ...
  const handleDeleteBook = async (id) => {
    try {
      const response = await fetch(`https://server.ppfi.site/api/lib/remove/${id}`, {
        method: 'DELETE'
      })
